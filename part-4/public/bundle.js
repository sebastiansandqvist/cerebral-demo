...
/* harmony export (immutable) */ __webpack_exports__["loadedItems"] = loadedItems;
...
/* harmony export (immutable) */ __webpack_exports__["setLoading"] = setLoading;
/* harmony export (immutable) */ __webpack_exports__["setQuery"] = setQuery;
/* harmony export (immutable) */ __webpack_exports__["setPage"] = setPage;
function loadedItems(products) {
  return {
    type: 'LOADED_ITEMS',
    items: products || []
  };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__actions_actionCreators__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Nav__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Cart__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_ProductList__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_SearchInput__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Title__ = __webpack_require__(26);
...
function mapDispatchToProps(dispatch) {
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_redux__["a" /* bindActionCreators */])(__WEBPACK_IMPORTED_MODULE_3__actions_actionCreators__, dispatch);
}
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentWillMount() {
      ...
      fetch('http://mithril-examples.firebaseio.com/books.json').then(function (response) {
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        null,
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8__components_Title__["a" /* default */], null),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_Nav__["a" /* default */], null),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__components_SearchInput__["a" /* default */], null),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__components_ProductList__["a" /* default */], null),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__components_Cart__["a" /* default */], null)
      );
    }
  }]);
...
/* harmony default export */ __webpack_exports__["a"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_redux__["b" /* connect */])(mapStateToProps, mapDispatchToProps)(App));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reducers__ = __webpack_require__(29);
...
/* harmony default export */ __webpack_exports__["a"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_redux__["b" /* connect */])(mapStateToProps, mapDispatchToProps)(ProductList));
...
var SearchInput = function SearchInput(_ref) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    'div',
    null,
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', value: query, onChange: function onChange(event) {
        return setQuery(event.target.value);
      }, placeholder: 'Search' })
  );
};

/* harmony default export */ __webpack_exports__["a"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_redux__["b" /* connect */])(mapStateToProps, mapDispatchToProps)(SearchInput));
...
var Title = function Title(_ref) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    'h1',
    null,
    isLoading ? 'Loading...' : pageMap[page]
  );
};

/* harmony default export */ __webpack_exports__["a"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_redux__["b" /* connect */])(mapStateToProps)(Title));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__App_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__store__ = __webpack_require__(22);
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_dom__["render"])(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
  ...
  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__App_js__["a" /* default */], null)
...
function productFilter(items, cart, query) {
  return items.filter(function (item) {
    return includes(item.name, query) && indexOfId(cart, item.id) === -1;
  });
}
...
function appReducer() {
  ...
  switch (action.type) {
    ...
    case 'SET_QUERY':
      {
        var query = action.value;
        var filteredItems = productFilter(state.items, state.cart, query).sort(alphabetically);
        return Object.assign({}, state, {
          query: query,
    ...
    case 'ADD_TO_CART':
      {
        ...
        var itemIndex = indexOfId(state.filteredItems, item.id);
        var cart = state.cart.concat(item);
        return Object.assign({}, state, {
          cart: cart,
          filteredItems: [].concat(_toConsumableArray(state.filteredItems.slice(0, itemIndex)), _toConsumableArray(state.filteredItems.slice(itemIndex + 1, state.filteredItems.length))).sort(alphabetically),
          total: sum(cart)
        });
      }
    case 'REMOVE_FROM_CART':
      {
        ...
        var _itemIndex = indexOfId(state.cart, _item.id);
        var _cart = [].concat(_toConsumableArray(state.cart.slice(0, _itemIndex)), _toConsumableArray(state.cart.slice(_itemIndex + 1, state.cart.length)));
        var _filteredItems = _item.name.toLowerCase().includes(state.query.toLowerCase()) && indexOfId(state.items, _item.id) !== -1 ? state.filteredItems.concat(_item).sort(alphabetically) : state.filteredItems;
        return Object.assign({}, state, {
          cart: _cart,
...
var rootReducer = __WEBPACK_IMPORTED_MODULE_1__app__["a" /* default */];
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(13), __webpack_require__(33)(module)))
...
/* harmony default export */ __webpack_exports__["a"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_redux__["b" /* connect */])(mapStateToProps, mapDispatchToProps)(Cart));
...
function fetchProducts(path) {
  return fetch('http://mithril-examples.firebaseio.com/' + path + '.json').then(function (response) {
    return response.json();
  });
}
...
var Nav = function (_Component) {
  ...
  _createClass(Nav, [{
    key: 'fetchItems',
    value: function fetchItems(page) {
      this.props.setLoading(true);
      this.props.setPage(page);
      if (page === 'all') {
        Promise.all([fetchProducts('books'), fetchProducts('movies')]).then(function (_ref) {
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'button',
          { onClick: function onClick() {
              return _this2.fetchItems('books');
            } },
          'View books'
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'button',
          { onClick: function onClick() {
              return _this2.fetchItems('movies');
            } },
          'View movies'
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
...
/* harmony default export */ __webpack_exports__["a"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_redux__["b" /* connect */])(mapStateToProps, mapDispatchToProps)(Nav));
